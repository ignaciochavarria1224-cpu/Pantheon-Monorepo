...
class Settings:
    ...
    SYMBOL_REENTRY_COOLDOWN_SECONDS: int # Minimum delay between same-symbol exit and re-entry
    ...
    RANKINGS_DIR: Path            # Directory for JSON ranking snapshots
...
def load_settings() -> Settings:
    ...
    rankings_dir = Path(_str_env("RANKINGS_DIR", str(_ROOT / "data" / "rankings")))
    ...
    return Settings(
        ...
        ATR_TARGET_MULTIPLIER=_float_env("ATR_TARGET_MULTIPLIER", 4.0),
        ...
        SYMBOL_REENTRY_COOLDOWN_SECONDS=_int_env("SYMBOL_REENTRY_COOLDOWN_SECONDS", 120),
