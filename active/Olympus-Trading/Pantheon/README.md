...
- `apps/olympus` - market data, ranking, paper-trading execution, enriched trade memory, and persistent Apex report generation
...
- `Olympus` is the trading execution source of truth, including market data fetch, ranking cycles, paper-trading logic, enriched trade memory, and Phase 5 Apex reports stored in SQLite for downstream consumers.
